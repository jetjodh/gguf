...
**for the latest update, gguf-connector deployment copy is now attached to the node itself; don't need to clone it to the site-packages; no dependencies right away; no extra step anymore**
