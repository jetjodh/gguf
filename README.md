...
#### other(s)
you are also welcome to get the node through other channels, i.e., comfy-cli, comfyui-manager (available now; search `gguf` from the bar; and opt to install it there should be fine; see picture below)
