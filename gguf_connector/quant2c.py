...
def dequantize_blocks_IQ2_S(blocks, block_size, type_size, dtype=None):
    ...
    signs = signs.reshape((n_blocks, -1, 1)) >> torch.arange([i for i in
        range(8)], dtype=torch.uint8, device=d.device).reshape((1, 1, 8))
